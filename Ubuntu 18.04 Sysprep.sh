...
# SETUP & RUN
# curl -sL https://raw.githubusercontent.com/mkeguy106/Ubuntu-18.04-SysPrep/master/Ubuntu%2018.04%20Sysprep.sh | sudo -E bash -
...
#wipe out the machine-id.  New machine-id will be generated on bootup.  Not doing this causes dhcp conflicts
rm /etc/machine-id
